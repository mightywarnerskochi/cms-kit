                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="site-panel-{{ $lang->code }}" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="translations[{{ $lang->code }}][company_name]" class="form-control @error("translations.{$lang->code}.company_name") is-invalid @enderror" value="{{ old("translations.{$lang->code}.company_name", $trans['company_name'] ?? $siteInfo->company_name) }}">
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        <textarea name="translations[{{ $lang->code }}][address]" class="form-control @error("translations.{$lang->code}.address") is-invalid @enderror" rows="3">{{ old("translations.{$lang->code}.address", $trans['address'] ?? $siteInfo->address) }}</textarea>
